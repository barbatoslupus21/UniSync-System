...
urlpatterns = [
    ...
    path('update-intransit-notes/<int:declaration_id>/', views.update_intransit_notes, name='update_intransit_notes'),
    path('arrived/<int:declaration_id>/', views.mark_arrived_stock_declaration, name='mark_arrived_stock_declaration'),
