...
urlpatterns = [
    ...
    path('new/', views.ecis_create, name='ecis_create'),
    path('<int:pk>/', views.ecis_detail_requestor, name='ecis_detail'),
    path('<int:pk>/edit/', views.ecis_edit, name='ecis_edit'),
    path('<int:pk>/cancel/', views.ecis_cancel, name='ecis_cancel'),
